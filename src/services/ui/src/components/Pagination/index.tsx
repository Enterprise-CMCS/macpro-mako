          ...
          >
            ...
            {state.pageRange.map((PAGE) => {
              if (Array.isArray(PAGE))
                return (
                  <button className="tw-relative tw-inline-flex tw-items-center tw-px-4 tw-py-2 tw-text-sm tw-font-semibold tw-text-gray-700 tw-ring-1 tw-ring-inset tw-ring-gray-300 focus:outline-offset-0 tw-cursor-pointer">
                    ...
                    <select
                      onChange={(v) =>
