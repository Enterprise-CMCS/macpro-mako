...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: ROUTES.WAIVER_SUBMISSION_OPTIONS, element: <P.WaiverSubmissionOptions /> },
      { path: ROUTES.B_WAIVER_SUBMISSION_OPTIONS, element: <P.BWaiverSubmissionOptions /> },
      { path: ROUTES.B4_WAIVER_OPTIONS, element: <P.B4WaiverSubmissionOptions /> },
      { path: ROUTES.BCAP_WAIVER_OPTIONS, element: <P.BCapWaiverSubmissionOptions /> },
      ...
      { path: ROUTES.MEDICAID_ABP_LANDING, element: <P.MedicaidABPLandingPage/> },
      { path: ROUTES.MEDICAID_ELIGIBILITY_LANDING, element: <P.MedicaidEligibilityLandingPage/> },
      { path: ROUTES.CHIP_ELIGIBILITY_LANDING, element: <P.CHIPEligibilityLandingPage/> },
