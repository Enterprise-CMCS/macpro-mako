  ...
  return (
    <>
      ...
      <section className="max-w-screen-xl m-auto px-4 lg:px-8 pt-8 gap-10">
        ...
        <div className="py-4 px-8 border-2 border-t-0 mt-0 mb-5">
          ...
          <ul className="p-3">
            ...
            <li className="mb-2">
              ...
              <a
                ...
                rel="noreferrer"
              >
                Voluntary Benefit Package Selection Assurances - Eligibility
            ...
            <li className="mb-2">
              ...
              <a
                ...
                rel="noreferrer"
              >
                Voluntary Enrollment Assurances for Eligibility Groups other
                than the Adult Group under Section 1902(a)(10)(A)(i)(VIII) of
                the Act
              </a>
            </li>
            <li className="mb-2">
          ...
          <ul className="p-3">
            <li className="mb-2">
              <a
                ...
                target="_blank"
              >
                Alternative Benefit Plan State Training Webinar (2013-08-13
                .wmv)
              </a>
            </li>
            <li className="mb-2">
