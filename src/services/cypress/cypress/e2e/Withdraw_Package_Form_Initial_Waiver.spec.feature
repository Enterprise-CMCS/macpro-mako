Feature: Verify user can withdraw a package in Under Review Status in the package dashboard
    ...
    Scenario: Validate Initial Waiver Withdrawal Page from dashboard
        ...
        Then type the generated "Initial Waiver Number" Number 5 into the ID Input box using the state "MD"
        ...
        Then search for the generated "Initial Waiver Number" Number 5
        Then verify the id number in the first row matches the generated "Initial Waiver Number" Number 5
    ...
    Scenario: Validate Initial Waiver Withdrawal Page from details page
        Then click on "1915(b) Comprehensive (Capitated) Waiver Authority" choice
        Then click on "1915(b) Comprehensive (Capitated) New Initial Waiver" choice
        Then type the generated "Initial Waiver Number" Number 6 into the ID Input box using the state "MD"
        Then set "Proposed Effective Date of 1915(b) Initial Waiver" to 3 months from today
        Then attach "file.docx" file to attachment 1
        Then attach "excel.xlsx" file to attachment 2
        Then into "Additional Information" type "This Initial Waiver package was created by the test automation."
        ...
        Then verify package submitted message in the alert bar
        Then click on the Waivers tab
        Then search for the generated "Initial Waiver Number" Number 6
        Then verify the id number in the first row matches the generated "Initial Waiver Number" Number 6
    ...
    Scenario: Validate Initial Waiver Withdrawal Page from dashboard
        ...
        Then type the generated "Initial Waiver Number" Number 7 into the ID Input box using the state "MD"
        Then set "Proposed Effective Date of 1915(b) Initial Waiver" to 3 months from today
        Then attach "file.docx" file to attachment 1
        Then attach "excel.xlsx" file to attachment 2
        Then into "Additional Information" type "This Initial Waiver package was created by the test automation."
        ...
        Then verify package submitted message in the alert bar
        Then click on the Waivers tab
        Then search for the generated "Initial Waiver Number" Number 7
        Then verify the id number in the first row matches the generated "Initial Waiver Number" Number 7
        Then click the actions button in row one
        Then click withdraw package button
        Then verify the form is titled "Withdraw Waiver"
        Then verify "Supporting Documentation" is an Attachment Type
    ...
    Scenario: Validate Initial Waiver Withdrawal Page from details page
        Then click on "1915(b)(4) FFS Selective Contracting Waivers" choice
        Then click on "1915(b)(4) FFS Selective Contracting New Initial Waiver" choice
        Then type the generated "Initial Waiver Number" Number 8 into the ID Input box using the state "MD"
        Then set "Proposed Effective Date of 1915(b) Initial Waiver" to 3 months from today
        Then attach "file.docx" file to attachment 1
        Then attach "excel.xlsx" file to attachment 2
        Then into "Additional Information" type "This Initial Waiver package was created by the test automation."
        ...
        Then verify package submitted message in the alert bar
        Then click on the Waivers tab
        Then search for the generated "Initial Waiver Number" Number 8
        Then verify the id number in the first row matches the generated "Initial Waiver Number" Number 8
        Then click the Waiver Number link in the first row
        Then verify the package details page is visible
        Then click withdraw button
        Then verify the form is titled "Withdraw Waiver"
