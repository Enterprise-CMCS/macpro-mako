Feature: RAI Response for Initial Waiver - Package View
    ...
    Scenario: create package, issue RAI and validate response to Comprehensive (Capitated) RAI from package dashboard
        ...
        Then type the generated "Initial Waiver Number" Number 3 into the ID Input box using the state "MD"
        ...
        Then search for the generated "Initial Waiver Number" Number 3
        Then verify the id number in the first row matches the generated "Initial Waiver Number" Number 3
    ...
    Scenario: create package, issue RAI and validate response to Comprehensive (Capitated) RAI from package details page
        Then click on "1915(b)(4) FFS Selective Contracting Waivers" choice
        Then click on "1915(b)(4) FFS Selective Contracting New Initial Waiver" choice
        Then type the generated "Initial Waiver Number" Number 9 into the ID Input box using the state "MD"
        Then set "Proposed Effective Date of 1915(b) Initial Waiver" to 3 months from today
        ...
        Then click the main Dashboard Button
        Then click on the Waivers tab
        Then search for the generated "Initial Waiver Number" Number 9
        Then verify the id number in the first row matches the generated "Initial Waiver Number" Number 9
