...
describe("Check a11y for New Waiver Action 1915(b) Comprehensive (Capitated) Renewal Waiver Page", () => {
  beforeEach(() => {
    cy.visit("/");
    ...
    cy.xpath("//h2[contains(text(),'1915(b) Comprehensive (Capitated) Renewal Waiver')]").click();
  });

  it("Check a11y for New Waiver Action 1915(b) Comprehensive (Capitated) Renewal Waiver Page", () => {
    cy.checkA11yOfPage();
  });
});