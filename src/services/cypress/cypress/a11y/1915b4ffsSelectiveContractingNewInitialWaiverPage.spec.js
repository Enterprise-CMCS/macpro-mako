...
describe("Check a11y for New Waiver 1915b4 FFS Selective Contracting New initial Waiver Waivers page", () => {
  beforeEach(() => {
    cy.visit("/");
    ...
    cy.xpath("//h2[contains(text(),'1915(b)(4) FFS Selective Contracting New Initial W')]").click();
  });

  it("Check a11y for New Waiver 1915b4 FFS Selective Contracting New initial Waiver Waivers page", () => {
    cy.checkA11yOfPage();
  });
});