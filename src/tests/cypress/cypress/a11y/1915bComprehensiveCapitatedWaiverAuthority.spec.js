...
describe("Check a11y for New Waiver Action 1915(b) Comprehensive (Capitated) Waiver Authority Page", () => {
  beforeEach(() => {
    cy.visit("/");
  ...
  it("Check a11y for New Waiver Action 1915(b) Comprehensive (Capitated) Waiver Authority Page", () => {
    cy.checkA11yOfPage();
  });
});