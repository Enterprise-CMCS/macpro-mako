...
describe("Check a11y for New Waiver 1915b4 FFS Selecting Contracting Waivers page", () => {
  beforeEach(() => {
    cy.visit("/");
  ...
  it("Check a11y for New Waiver 1915b4 FFS Selecting Contracting Waivers page", () => {
    cy.checkA11yOfPage();
  });
});