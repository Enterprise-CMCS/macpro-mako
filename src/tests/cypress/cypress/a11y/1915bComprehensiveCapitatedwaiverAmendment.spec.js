...
describe("Check a11y for New Waiver Action 1915(b) Comprehensive (Capitated) Waiver Amendment Page", () => {
  beforeEach(() => {
    cy.visit("/");
    ...
    cy.xpath("//h2[contains(text(),'1915(b) Comprehensive (Capitated) Waiver Amendment')]").click();
  });

  it("Check a11y for New Waiver Action 1915(b) Comprehensive (Capitated) Waiver Amendment Page", () => {
    cy.checkA11yOfPage();
  });
});