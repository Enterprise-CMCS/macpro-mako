...
export class oneMacDevLoginPage {
  loginAs(userRole, userStatus) {
    cy.origin(Cypress.env('cognito_domain'), { args: { EmailInput, PasswordInput, LOGIN_FIXTURE, DEFAULT_DEV_WORD, LoginBtn, userRole, userStatus } }, ({ EmailInput, PasswordInput, LOGIN_FIXTURE, DEFAULT_DEV_WORD, LoginBtn, userRole, userStatus}) => {
