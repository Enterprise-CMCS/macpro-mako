...
const generateIdToken = (user: TestUserData): string | null => {
  if (user) {
    jwt.sign({
      at_hash: "HBP_ybFNE5bl-2JPXlJvIQ",
      sub: "d4284448-3091-7066-2b41-cb9d57de9194",
      email_verified: true,
      iss: "https://cognito-idp.us-east-1.amazonaws.com/us-east-1_n12JUn0cM",
      "cognito:username": "d4284448-3091-7066-2b41-cb9d57de9194",
      origin_jti: "d0ff86c0-c5a5-4fb8-a9b8-08e90c7d7fc5",
      aud: "7rqds9ii98ibi2iuk06oqbnrts",
      event_id: "1396ef95-5379-441e-826c-4316256c0980",
      token_use: "id",
      auth_time: 1733760947,
      exp: 1733762747,
      iat: 1733760947,
