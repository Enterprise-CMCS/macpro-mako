...
import { transform } from "./capitated-initial";
import { SEATOOL_STATUS } from "shared-types";
import * as dateHelper from "../../../../shared-utils/seatool-date-helper";

describe("capitated-initial transform", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  const mockData = {
    id: "NY-12345.R00.00", // Initial waiver format
  ...
  it("should transform capitated-initial data correctly", () => {
