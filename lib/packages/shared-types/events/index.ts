...
import { buildChipSchema } from "./new-chip-submission";
...
const _builtSchema = buildChipSchema(false);
export type NewChipSubmission = z.infer<typeof _builtSchema>;
...
export type Events = {
  ...
  NewChipSubmission: NewChipSubmission;
