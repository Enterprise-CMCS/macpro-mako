import { Action, Authority, CommonEmailVariables, EmailAddresses, RaiWithdraw } from "shared-types";
...
export const withdrawRai: AuthoritiesWithUserTypesTemplate = {
  ...
  [Authority["1915b"]]: {
    cms: async (variables: RaiWithdraw & CommonEmailVariables & { emails: EmailAddresses }) => {
      const relatedEvent = await getLatestMatchingEvent(variables.id, Action.RESPOND_TO_RAI);
      return {
