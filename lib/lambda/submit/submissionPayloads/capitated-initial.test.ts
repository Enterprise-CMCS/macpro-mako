...
describe("capitated intiial payload", () => {
  ...
  it("should be unauthorized", async () => {
    ...
    await expect(capitatedInitial(mockEvent)).rejects.toThrow("Unauthorized");
  ...
  it("should have no body on submission and throw an error", async () => {
    ...
    const result = await capitatedInitial(mockEvent);
  ...
  it("should find an item already exists", async () => {
    ...
    await expect(capitatedInitial(mockEvent)).rejects.toThrow("Item Already Exists");
