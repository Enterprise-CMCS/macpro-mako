...
export class CloudWatchLogsResourcePolicy extends Construct {
  ...
  constructor(scope: Construct, id: string, props: CloudWatchLogsResourcePolicyProps) {
    super(scope, id);
    const stack = Stack.of(this);
    this.policy = new CfnResourcePolicy(this, `CentralizedCloudWatchLogsResourcePolicy`, {
