...
## Legacy Onemac S3 Deletion Checklist

- [ ] Testing and review confirms no unresolved attachment-access issues.
- [ ] Final stakeholder sign-off completed.
- [ ] Enable bucket Inventory for ancoing audit purposes
- [ ] Object lock / retention settings reviewed and handled.
- [ ] Delete protection settings reviewed.
- [ ] Legacy bucket deletions executed.
