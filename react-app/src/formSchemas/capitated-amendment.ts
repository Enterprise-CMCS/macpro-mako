...
export const formSchema = events["capitated-amendment"].baseSchema
  .extend({
    id: events["capitated-amendment"].baseSchema.shape.id
    ...
    waiverNumber: events["capitated-amendment"].baseSchema.shape.waiverNumber.superRefine(
      async (value, ctx) => {
