export const WithdrawSpaRaiResponse = () => (
  <div className="w-full space-y-2">
    ...
    <ul className="list-disc ml-7">
      <li>As a CMS user, log in to OneMAC and select the link to the SPA ID from the dashboard</li>
      <li>
    ...
    <p>
      ...
      Response feature has been enabled, locate and select the Medicaid SPA submission package.
    </p>
    <p>
