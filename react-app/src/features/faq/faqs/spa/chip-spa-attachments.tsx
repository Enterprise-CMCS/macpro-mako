export const ChipSpaAttachments = ({
  ...
  <>
    {isChipSpaDetailsEnabled && <p className="font-bold">CHIP SPA Attachment Types:</p>}
        ...
        <table className="faq-eligibility-table ml-12 border-collapse border border-gray-300 w-full ">
          <tbody>
            ...
            <tr>
              <td className="border border-gray-300 px-4 py-2">Cover Letter*</td>
              <td className="border border-gray-300 px-4 py-2">
                Cover letter to CMS with an authorized signature that outlines the purpose of the
                CHIP SPA submission
              </td>
            </tr>
            <tr>
