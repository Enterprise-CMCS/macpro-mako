          ...
          <>
            ...
            <div className="onboarding-videos">
              ...
              <Accordion
                ...
                collapsible
                onValueChange={() => {
                  const triggerElement = document.getElementById("video-trigger-1");
              ...
              >
                <AccordionItem className="border-none" value="video-1">
                  <AccordionTrigger
                  ...
                  <AccordionContent>
                    <div className="space-y-2">
                      <p>
                        ...
                        OneMAC's new and improved submission package dashboard. We will demonstrate
                        the new view along with some additional features and functionality that it
                        provides.
                      </p>
                      <p>
                        Please note, this video was recorded in a training environment and does not
                        reflect actual data. Additionally, some screens may look different than what
                        you will see in OneMAC.
                      </p>
                      <p>
                        ...
                        order to switch the view to show waivers, you can select the Waivers tab at
                        the top of the dashboard. Similarly, you can switch back to viewing State
                        Plan Amendments by selecting the SPAs tab.
                      </p>
                      <p>
                      ...
                      <p>
                        OneMAC now has several ways to make finding submitted State Plan Amendments
                        and waivers easier. You can now filter the Package Dashboard by selecting
                        the Filter button. Once the button is clicked, a box on the right-hand side
                        of the dashboard will appear and provides you with options to filter by
                        State, Type, Status, and Initial Submission Date. You will only have the
                        option to filter by states that you have an approved role for.
                      </p>
                      <p>
                        ...
                        Submitter Name. As you type in the search text box, the list of submissions
                        will automatically narrow to those that match. To view a submission package,
                        which includes the initial submission and any associated formal RAI
                        responses, select the link to the SPA ID or waiver number from the Package
                        Dashboard. This page contains all of the information that was submitted
                        through OneMAC about the submission package.
                      </p>
                      <p>
                      ...
                      <p>
                        ...
                        what status the package is in. Both State Plan Amendments and waiver
                      ...
                      <p>
                        Selecting the Respond to RAI link under Package Actions will bring you to a
                        page where you can add the required formal RAI response attachments as well
                        as any additional information for CMS. After all required information has
                        been added, you can click Submit to send the formal RAI response to CMS.
                      </p>
                      <p>
                      ...
                      <p>
                        ...
                        your submission package is in either the Under Review or the RAI Issued
                        status.
                      </p>
                      <p>
                        ...
                        package cannot be resubmitted. If you are certain that you wish to withdraw
                        the submission, select "Yes, withdraw package" to complete the task.
                      </p>
                      <p>
                        This functionality cannot be used to withdraw a Formal RAI response. To
                        withdraw a Formal RAI response, you will need to work with your CMS Point of
                        Contact directly. Additionally, Package Actions can also be taken directly
                        from the Package Dashboard. While on the Package Dashboard, the right most
                        column is the Actions column. For submission packages with available
                        actions, the three dots icon can be selected and a dropdown list will appear
                        showing the actions that can be taken.
                      </p>
                      <p>
                  ...
                  <AccordionContent>
                    <div className="space-y-2">
                      ...
                      <p>
                        ...
                        actions in OneMac, either directly from the package dashboard as an option
                        in the actions column drop-down menu, or from within the submission package
                        itself under the package actions section.
                      </p>
                      <p>
                        After selecting the upload subsequent documents package action, you are
                        taken to the subsequent documentation details page. Select the add file
                        button for the appropriate document type to add any additional documents
                        that need to be submitted to CMS. You can submit multiple documents at once,
                        however, at least one attachment is required. Next, fill out the reason for
                        subsequent documentation section, explaining why additional documents are
                        being submitted.
                      </p>
                      <p>
                        ...
                        submission package and reviewed by CMS. If you are certain you wish to add
                        these documents to the submission package, select yes, submit. A green
                        banner is shown indicating that the documents have been submitted and CMS
                        reviewers will follow up by email if additional information is needed.
                        Additionally, an email notification will be sent indicating that the action
                        was taken and CMS will be notified. A new latest package activity field was
                        also added to the package dashboard and submission package details section.
                        This field will automatically update to reflect when the most recent package
                        action occurred, including when subsequent documentation is submitted.
                      </p>
                      <p>
                        Thank you for watching this overview of the latest OneMAC updates. If you
                        have any questions, please free to contact the OneMAC Help Desk at{" "}
