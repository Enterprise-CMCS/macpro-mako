...
describe("Default Welcome", () => {
  ...
  it("renders the page without banner hidden", () => {
    ...
    expect(
      screen.getByText(
        "The CS 18 CHIP eligibility SPA template and implementation guide have been updated in OneMAC to include compliance attestations for changes made by section 71109 of the Working Families Tax Cut (WFTC) legislation effective October 1, 2026. These updates to the CS18 will be effective starting July 7, 2026.",
      ),
    ).toBeInTheDocument();
