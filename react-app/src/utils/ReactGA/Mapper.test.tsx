...
describe("mapSubmissionTypeBasedOnActionFormTitle", () => {
  ...
  it("maps 'Temporary Extension Request Details' correctly", () => {
    expect(
      mapSubmissionTypeBasedOnActionFormTitle("Temporary Extension Request Details")
    ).toBe("temporary extension");
  });
  ...
  it("maps '1915(c) Appendix K Amendment Details' correctly", () => {
    expect(
      mapSubmissionTypeBasedOnActionFormTitle("1915(c) Appendix K Amendment Details")
    ).toBe("1915c app-k");
  });
