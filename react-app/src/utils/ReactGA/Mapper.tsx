export function mapSubmissionTypeBasedOnActionFormTitle(actionFormTitle) {
    ...
    } else if (actionFormTitle.includes("1915(b)(4) FFS Selective Contracting Initial Waiver Details")) {
       mappedTitle="1915b(4) initial waiver";
    } else if (actionFormTitle.includes("1915(b)(4) FFS Selective Contracting Renewal Waiver Details")) {
       mappedTitle="1915b(4) waiver renewal";
    } else if (actionFormTitle.includes("1915(b)(4) FFS Selective Contracting Waiver Amendment Details")) {
    ...
    } else if (actionFormTitle.includes("1915(b) Comprehensive (Capitated) Waiver Amendment Details")) {
